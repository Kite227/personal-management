        ...
        <c:forEach items="${blogsInfo.list }" var="blog_recall">
         <div class="blogs">
                ...
                <ul>
                    ...
                    <p class="autor">
                        <span class="lm f_l"><a href="${ctx }/blog/list.do" style="color: #759b08">韶华追忆</a></span>
      	...
      	<div class="pagelist">
      		<div class="pages" style="text-align:center;">
		  		<!--分页条信息-->
           	  	<div class="col-md-12">
					 <ul class="pagination">
			 			<li><a href="${ctx }/blog/list.do?pn=1&typeId=1">首页</a></li>
			 			<c:if test="${blogsInfo.hasPreviousPage}">
			 			<li><a href="${ctx }/blog/list.do?pn=${blogsInfo.pageNum-1}&typeId=1">&laquo;</a></li>
			 			</c:if>
			  			<c:forEach items="${blogsInfo.navigatepageNums}" var="page_Num">
				   		...
				   		<li><a href="${ctx }/blog/list.do?pn=${page_Num}&typeId=1">${page_Num}</a></li>  <!-- 显示下一页 -->
				   		</c:if>
					 	</c:forEach>
					 	<c:if test="${blogsInfo.hasNextPage}">		 
				   		<li><a href="${ctx }/blog/list.do?pn=${blogsInfo.pageNum+1}&typeId=1">&raquo;</a></li>
				   		</c:if>
				    	<li><a href="${ctx }/blog/list.do?pn=${blogsInfo.pages}&typeId=1">末页</a></li>    
				   </ul> 
			   </div>          	
			</div>
	  	</div>
